...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="/adminhome/head.html"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="/adminhome/left.html" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="/adminhome/main.html" name="main" scrolling="yes" noresize="noresize"
